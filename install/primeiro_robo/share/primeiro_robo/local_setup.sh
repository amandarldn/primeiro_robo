...
: ${AMENT_CURRENT_PREFIX:="/home/user/dev_ws/src/primeiro_robo/install/primeiro_robo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/primeiro_robo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/primeiro_robo/environment/path.sh"
